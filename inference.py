...
async def main() -> None:
    ...
    try:
        ...
        final_score = clamp_score(sum(all_rewards) / MAX_TOTAL_REWARD)
        ...
        print(f"[END] success={success} steps={step_idx-1} score={final_score:.2f} rewards={rewards_str}", flush=True)
